...
- 讣告与悼文是罕见栏目，只有失城、首都陷落、亡国边缘、fallenCivilizations 确认灭亡或 brief 明确强烈支持时才写；不要因为某国偏弱就例行写悼文。
...
- 讣告与悼文：仅在某文明出现失城、亡国边缘、首都陷落、确认灭亡或强烈衰亡叙事时使用。
- 史馆档案：文言、诏书、檄文、罪己诏。
...
- 如果 brief 中存在 obituaryTrigger=true 的亡国记录，本期必须至少有一个版面处理这件亡国级事件；可以不做头版，但不能略过。
